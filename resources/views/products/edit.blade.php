            ...
            <div class="glass-card">
                <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom border-white border-opacity-10">
                    <h5 class="fw-bold mb-0">
                        <i class="bi bi-pencil-square text-indigo-400 me-2"></i> Form Edit Barang: {{ $product->name }}
                    </h5>
                ...
                <form action="{{ route('products.update', $product->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control form-control-custom" placeholder="Masukkan nama barang..." value="{{ old('name', $product->name) }}" required>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="stock" class="form-label-custom">Jumlah Stok</label>
                            <input type="number" name="stock" id="stock" class="form-control form-control-custom" placeholder="0" min="0" value="{{ old('stock', $product->stock) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="barcode" class="form-label-custom">Barcode</label>
                        <input type="text" name="barcode" id="barcode" class="form-control form-control-custom" placeholder="Barcode..." value="{{ old('barcode', $product->barcode) }}" required>
                    </div>

                    <div class="mb-4">
                        <label for="description" class="form-label-custom">Deskripsi Barang</label>
                        <textarea name="description" id="description" class="form-control form-control-custom" rows="4" placeholder="Tulis deskripsi barang...">{{ old('description', $product->description) }}</textarea>
                    </div>
